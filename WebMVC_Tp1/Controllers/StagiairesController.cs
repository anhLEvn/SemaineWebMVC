...
using WebMVC_Tp1.Models;

namespace WebMVC_Tp1.Controllers
{
    public class StagiairesController : Controller
    {
        private DBStagiairesContext db = new DBStagiairesContext();
        ...
        public ActionResult Create([Bind(Include = "Id,Nom,Prenom,DateNaissance,Email")] Stagiaire stagiaire)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nom,Prenom,DateNaissance,Email")] Stagiaire stagiaire)
        {
            if (ModelState.IsValid)
            {
